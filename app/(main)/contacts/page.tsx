...
const ContactsPage: React.FC = () => {
    ...
    const { data, isLoading } = useConvexQuery<ContactResponse>(api.contacts.getAllContacts);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {users && users.length === 0 ? (
                        <Card>
                            <CardContent className="py-6 text-center text-muted-foreground">
                                There is no contacts available. Kindly add an expense with someone
                                to be able to see.
                            </CardContent>
                        </Card>
                    ) : (
                ...
                <div>
                    ...
                    {groups && groups.length === 0 ? (
                        <Card>
                            <CardContent className="py-6 text-center text-muted-foreground">
                                There are no groups available. Kindly create a group to start
                                sharing expenses.
                            </CardContent>
                        </Card>
                    ) : (
